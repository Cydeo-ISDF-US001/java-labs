...
// Write a program (using “do-while” loop) that generates
// and prints the FINRA pattern up to a given number.
//
// The FINRA pattern is a sequence of numbers where certain
// numbers are replaced with specific words.
